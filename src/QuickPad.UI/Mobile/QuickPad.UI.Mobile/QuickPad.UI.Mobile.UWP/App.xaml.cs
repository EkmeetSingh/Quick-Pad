...
using QuickPadCommands =
    QuickPad.Mvvm.Commands.WindowsQuickPadCommands<Windows.Storage.StorageFile, Windows.Storage.Streams.IRandomAccessStream>;
...
namespace QuickPad.UI
{
    ...
    sealed partial class App : Mvvm.IApplication<StorageFile, IRandomAccessStream>
    {
        ...
        public App()
        {
            ...
            Host = new HostBuilder().ConfigureAppConfiguration(builder =>
                {
                ...
                }).ConfigureServices(ApplicationStartup.ConfigureServices).ConfigureServices(collection =>
                {
                    collection.AddSingleton(provider => Resources);
                }).ConfigureLogging(builder =>
                {
                    builder.AddConsole();
                })
                .ConfigureHostConfiguration(ApplicationStartup.Configure).BuildApplicationHost<StorageFile, IRandomAccessStream, WindowsDocumentManager>();
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (mainPage == null)
            {
                ...
                if (!Resources.ContainsKey(nameof(QuickPadCommands))) Resources.Add(nameof(QuickPadCommands), ServiceProvider.GetService<QuickPadCommands>());
                ...
                _ = Resources[nameof(ResourceLoader)] as ResourceLoader;
            ...
            if (e.PrelaunchActivated == false)
            {
                if (mainPage == null)
                {
                    ...
                    // parameter
                    _ = ServiceProvider.GetService<MainPage>();
                }
        ...
        public string GetPath(string baseb, string arg)
        {
            ...
            if (arg.Contains(":"))
            {
                if (arg.Contains("\""))
                {
                    ...
                    {
                        int index = arg.IndexOf("\"", 3, StringComparison.Ordinal) + 2;
        ...
        public SettingsViewModel<StorageFile, IRandomAccessStream> SettingsViewModel => _settings;
        ...
        {
            CoreApplication.MainView.DispatcherQueue.TryEnqueue(() => action());
        }
        ...
        DocumentViewModel<StorageFile, IRandomAccessStream> Mvvm.IApplication<StorageFile, IRandomAccessStream>.CurrentViewModel => CurrentViewModel;
    }
}
