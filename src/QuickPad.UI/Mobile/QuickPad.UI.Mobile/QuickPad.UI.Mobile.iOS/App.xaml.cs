...
using QuickPadCommands =
    QuickPad.Mvvm.Commands.QuickPadCommands<Windows.Storage.StorageFile, Windows.Storage.Streams.IRandomAccessStream>;
    ...
    sealed partial class App : QuickPad.Mvvm.IApplication<Windows.Storage.StorageFile, Windows.Storage.Streams.IRandomAccessStream>
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (mainPage == null)
            {
                ...
                if (!Resources.ContainsKey(nameof(QuickPadCommands))) Resources.Add(nameof(QuickPadCommands), ServiceProvider.GetService<QuickPad.Mvvm.Commands.QuickPadCommands<StorageFile, IRandomAccessStream>>());
