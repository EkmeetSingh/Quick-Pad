...
namespace QuickPad.UI.Theme
{
    ...
    public class VisualThemeSelector : IVisualThemeSelector
    {
        ...
        private readonly SettingsViewModel<StorageFile, IRandomAccessStream> _settingsViewModel;
        ...
        public VisualThemeSelector(
            ...
            , SettingsViewModel<StorageFile, IRandomAccessStream> settingsViewModel
        ...
        {
            if (e.PropertyName == nameof(SettingsViewModel<StorageFile, IRandomAccessStream>.CustomThemeId) &&
        ...
        private VisualTheme GetThemeFromId(string id)
        {
            ...
            var match = ThemesView.OfType<VisualTheme>().FirstOrDefault(x => comparer.Equals((string) x.ThemeId, id));
