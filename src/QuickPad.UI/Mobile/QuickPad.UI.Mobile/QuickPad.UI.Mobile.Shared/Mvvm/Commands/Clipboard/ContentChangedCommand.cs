...
{
    public class ContentChangedCommand : SimpleCommand<DocumentViewModel<StorageFile, IRandomAccessStream>>, IContentChangedCommand<StorageFile, IRandomAccessStream>, ICommand
    {
