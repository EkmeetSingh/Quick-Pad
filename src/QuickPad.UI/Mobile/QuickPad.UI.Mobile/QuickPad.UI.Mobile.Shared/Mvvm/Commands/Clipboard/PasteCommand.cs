...
{
    public class PasteCommand : SimpleCommand<DocumentViewModel<StorageFile, IRandomAccessStream>>, IPasteCommand<StorageFile, IRandomAccessStream>, ICommand
    {
        private readonly SettingsViewModel<StorageFile, IRandomAccessStream> _settings;
        private bool _canPasteText;

        public PasteCommand(SettingsViewModel<StorageFile, IRandomAccessStream> settingsViewModel)
        {
