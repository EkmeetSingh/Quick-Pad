...
{
    public class RateAndReviewCommand : SimpleCommand<SettingsViewModel<StorageFile, IRandomAccessStream>>, IRateAndReviewCommand<StorageFile, IRandomAccessStream>, ICommand
    {
