...
namespace QuickPad.UI.Dialogs
{
    public sealed partial class GoToLine : IGoToLineView<StorageFile, IRandomAccessStream>
    {
        ...
        {
            return (await ShowAsync(ContentDialogPlacement.Popup).AsTask()) == ContentDialogResult.Primary;
        }

        public GoToLine(IQuickPadCommands<StorageFile, IRandomAccessStream> commands)
        {
            Commands = commands;
