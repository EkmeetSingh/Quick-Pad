...
namespace QuickPad.UI.Dialogs
{
    public sealed partial class AskToSave : IDialogView
    {
        ...
        public AskToSave(IQuickPadCommands<StorageFile, IRandomAccessStream> commands, ResourceLoader resourceLoader)
        {
            Commands = commands;
...
#else
            ((TextBlock)Content).Text = ResourceLoader.GetString("WouldYouLikeToSave/Text");
#endif
