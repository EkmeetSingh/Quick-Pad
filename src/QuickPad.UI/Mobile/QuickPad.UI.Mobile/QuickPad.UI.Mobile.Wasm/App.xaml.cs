...
using WasmQuickPadCommands =
    QuickPad.Mvvm.Commands.WasmQuickPadCommands<Windows.Storage.StorageFile, Windows.Storage.Streams.IRandomAccessStream>;
...
namespace QuickPad.UI
{
    ...
    {
        private static WasmSettingsViewModel _settings;
        public static ApplicationHost<StorageFile, IRandomAccessStream, WasmDocumentManager> Host { get; set; }
        public static ApplicationController<StorageFile, IRandomAccessStream, WasmDocumentManager> Controller => Host?.Controller;
        public static IServiceProvider ServiceProvider => Host?.Services;
        public IServiceProvider Services => Host?.Services;
        public static WasmSettingsViewModel Settings => _settings ??= Host?.Services.GetService<WasmSettingsViewModel>();
        public static RichEditBox RichEditBox { get; internal set; }

        public static WasmQuickPadCommands Commands => ServiceProvider.GetService<WasmQuickPadCommands>();
        ...
        public App()
        {
            ...
            Host = new HostBuilder()
                ...
                .BuildApplicationHost<StorageFile, IRandomAccessStream, WasmDocumentManager>();
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (mainPage == null)
            {
                ...
                if (!Resources.ContainsKey(nameof(WasmQuickPadCommands))) Resources.Add(nameof(WasmQuickPadCommands), ServiceProvider.GetService<QuickPad.Mvvm.Commands.WasmQuickPadCommands<StorageFile, IRandomAccessStream>>());
                if (!Resources.ContainsKey(nameof(WasmSettingsViewModel))) Resources.Add(nameof(WasmSettingsViewModel), ServiceProvider.GetService<WasmSettingsViewModel>());
        ...
        protected override async void OnFileActivated(FileActivatedEventArgs args)
        {
            ...
            if (!Resources.ContainsKey(nameof(WasmQuickPadCommands)))
                Resources.Add(nameof(WasmQuickPadCommands), ServiceProvider.GetService<WasmQuickPadCommands>());
            if (!Resources.ContainsKey(nameof(WasmSettingsViewModel)))
                Resources.Add(nameof(WasmSettingsViewModel), ServiceProvider.GetService<WasmSettingsViewModel>());
        ...
        private async void MainPageOnLoaded(object sender, RoutedEventArgs e)
        {
            ...
            {
                var windowsDocumentManager = ServiceProvider.GetService<WasmDocumentManager>();
